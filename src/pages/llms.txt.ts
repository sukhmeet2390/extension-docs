...
const CHROME_EXTENSIONS = [
  ...
  },
  {
    ...
    description:
      'Free Chrome extension that blurs sensitive Discord content (server list, channels, DMs, avatars) during screen sharing. Not yet published on Chrome Web Store.',
    cwsUrl: null,
    hasPrivacy: true,
    hasTerms: false,
  },
  {
    ...
    description:
      'Free Chrome extension that blurs sensitive Microsoft Teams content (chats, channels, calendar, notifications) during screen sharing. Not yet published on Chrome Web Store.',
    cwsUrl: null,
    hasPrivacy: true,
    hasTerms: false,
  },
  {
    ...
    description:
      'Free Chrome extension that blurs sensitive WhatsApp Web content (chat list, previews, avatars, media) during screen sharing. Not yet published on Chrome Web Store.',
    cwsUrl: null,
    hasPrivacy: true,
    hasTerms: false,
  },
...
const SHOPIFY_APPS = [
  ...
  },
  {
    ...
    description:
      'Multi-channel chat widget for Shopify — one floating button that opens 9 channels (WhatsApp, Messenger, Instagram, LINE, Viber, Telegram, SMS, Email, phone). Free forever, no visitor cap, zero cookies, Shadow DOM isolated, 8-language admin.',
